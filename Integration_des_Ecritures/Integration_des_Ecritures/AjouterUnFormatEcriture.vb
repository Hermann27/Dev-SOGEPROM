...
Public Class AjouterUnFormatEcriture
    ...
    Private Sub DataListeFormat_CellClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataListeFormat.CellClick
        ...
        End If
    End Sub
    Private Sub AjouterUnFormatEcriture_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub BT_Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BT_Save.Click
        ...
        Try
            For n = 0 To DataListeFormat.RowCount - 1
                OleAdaptaterFormat = New OleDbDataAdapter("select * from FORMATECRITURE where Nom_Format='" & Trim(DataListeFormat.Rows(n).Cells("Format").Value) & "'", OleConnenection)
                ...
                If OledatableFormat.Rows.Count = 0 Then
                    SaveFormat = "Insert Into FORMATECRITURE (Format,Nom_Format) VALUES ('" & DataListeFormat.Rows(n).Cells("Chemin").Value & "','" & DataListeFormat.Rows(n).Cells("Format").Value & "')"
