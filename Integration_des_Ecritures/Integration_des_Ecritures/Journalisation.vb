...
Public Class Journalisation
    ...
    Private Sub Journalisation_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            If Directory.Exists(Pathsfilejournal) = True Then
                Me.WindowState = FormWindowState.Maximized
                OuvreLaListedeFichier(Pathsfilejournal)
            Else
                MsgBox("Le Chemin d'accès est Invalide" & Pathsfilejournal, MsgBoxStyle.Information, "Repertoire Journal")
            End If
