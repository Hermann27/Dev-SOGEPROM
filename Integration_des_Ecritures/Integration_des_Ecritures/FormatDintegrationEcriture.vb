...
Public Class FormatDintegrationEcriture
    ...
    Private Sub AfficheColDispo()
        ...
        Try
            OleAdaptater = New OleDbDataAdapter("select * from COECRITURE", OleConnenection)
        ...
        Try
            If SaveFileXml.ShowDialog = Windows.Forms.DialogResult.OK Then
                If SaveFileXml.FileName <> "" Then
                    ...
                    OleAdaptaterFormat = New OleDbDataAdapter("select * from FORMATECRITURE where Nom_Format='" & Trim(NameFormat(UBound(NameFormat))) & "'", OleConnenection)
                    ...
                    If OledatableFormat.Rows.Count = 0 Then
                        ...
                        Filexml.WriteEndElement()
                        Filexml.Close()
                        SaveFormat = "Insert Into FORMATECRITURE (Format,Nom_Format) VALUES ('" & SaveFileXml.FileName & "','" & Trim(NameFormat(UBound(NameFormat))) & "')"
    ...
    Private Sub AfficheFormat()
        ...
        Try
            OleAdaptaterAfficheFormat = New OleDbDataAdapter("select * from FORMATECRITURE", OleConnenection)
    ...
    Private Sub DeleteFormat()
        ...
        Try
            If File.Exists(Txt_Chemin.Text) = True Then
                DelFormat = "Delete  from FORMATECRITURE where Format='" & Txt_Chemin.Text & "'"
    ...
    Private Sub DeleteColDispo()
        ...
        Try
            ...
            If Colbool = False Then
                OleAdaptaterDeleteDispo = New OleDbDataAdapter("select * from COECRITURE where Libelle='" & DataDispo.Rows(CellCol).Cells("ColDispo").Value & "'", OleConnenection)
    ...
    End Sub
    Private Sub FormatDintegrationEcriture_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub Cmb_Format_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Cmb_Format.Click
    ...
    Private Sub Cmb_Format_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Cmb_Format.SelectedIndexChanged
        ...
        Try
            OleAdaptaterCmb = New OleDbDataAdapter("select * from FORMATECRITURE where Nom_Format='" & Trim(Cmb_Format.Text) & "'", OleConnenection)
